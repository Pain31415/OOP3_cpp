...
var::var(const char* stringValue) : valueType(STRING), data({new std::string(stringValue)}) {}

var::var(const std::string& stringValue) : valueType(STRING), data({new std::string(stringValue)}) {}
